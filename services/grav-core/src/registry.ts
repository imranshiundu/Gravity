...
export const gravCoreModules: GravityModule[] = [
  ...
  },
  {
    ...
    capabilities: [
      ...
      { id: "coding.openhands.run", title: "OpenHands execution", description: "Registered as dangerous and approval-gated, but intentionally unavailable until the actual execution contract and sandbox policy are reviewed.", status: "registered" },
      { id: "coding.aider.run", title: "Aider execution", description: "Registered as dangerous and approval-gated, but intentionally unavailable until the CLI/edit contract and rollback policy are reviewed.", status: "registered" },
      { id: "coding.claw.run", title: "Claw execution", description: "Registered as dangerous and approval-gated, but intentionally unavailable until the module contract and sandbox policy are reviewed.", status: "registered" },
    ],
  },
  {
    id: "defense",
